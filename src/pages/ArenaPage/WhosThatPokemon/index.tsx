    ...
    <div className="w-full flex flex-col justify-between h-[calc(100vh-theme(spacing.20))] max-h-[860px] min-h-[580px] select-none">
      ...
      <div className="flex items-center justify-between pb-4 border-b border-slate-200/90 dark:border-slate-800">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-2xl bg-amber-500 text-white flex items-center justify-center shrink-0 shadow-xs">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-amber-50 dark:bg-amber-950/40 border border-amber-200/80 dark:border-amber-900/60 text-amber-800 dark:text-amber-300 text-xs font-bold font-mono">
            <Flame
              ...
              <img
                ...
                className={`max-h-[200px] sm:max-h-[240px] md:max-h-[270px] w-auto object-contain transition-all duration-500 select-none pointer-events-none ${
                  isRevealed
                    ...
                    : 'brightness-0 opacity-95 contrast-200 scale-95 dark:invert-0'
                }`}
                style={{
                  userSelect: 'none',
                  WebkitUserDrag: 'none',
                ...
                >
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    ...
                    <button
                      ...
                      className="px-5 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-600 disabled:bg-slate-100 dark:disabled:bg-slate-800 disabled:text-slate-400 dark:disabled:text-slate-500 disabled:cursor-not-allowed text-white font-bold text-xs flex items-center gap-1.5 cursor-pointer transition-all active:scale-95 shadow-xs"
                    >
                      <span>Guess</span>
              ...
              >
                ...
                <div className="flex items-center gap-2 ml-auto">
                  ...
                  <button
                    type="button"
                    onClick={loadNextRound}
                    className="px-5 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-600 text-white font-bold text-xs flex items-center gap-1.5 cursor-pointer transition-all active:scale-95 shadow-xs"
                  >
