            ...
            <div className="hidden lg:flex w-full lg:w-1/2 items-center justify-center">
              <div className="w-full max-w-md lg:max-w-lg rounded-2xl bg-slate-50/90 dark:bg-slate-950/80 text-slate-800 dark:text-slate-200 p-6 sm:p-7 border border-slate-200/90 dark:border-slate-800/80 shadow-2xs relative overflow-hidden space-y-4">
                <div className="flex items-center justify-between pb-3 border-b border-slate-200/80 dark:border-slate-800">
                  ...
                  <span className="text-[11px] font-mono px-2.5 py-0.5 rounded bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800/60 font-semibold">
                    SYNCED
                  </span>
                </div>
                ...
                {/* Mini Grid of Species in Clean Cards */}
                <div className="grid grid-cols-3 gap-2.5 pt-1">
                  {/* #006 Charizard */}
                  <div className="bg-white dark:bg-slate-900 rounded-xl p-2.5 border border-slate-200/80 dark:border-slate-800 shadow-2xs flex flex-col items-center text-center">
                    <span className="text-[10px] font-mono text-slate-400 dark:text-slate-500 self-start">#006</span>
                    <img
                      src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/6.png"
                      alt="Charizard"
                      className="w-14 h-14 object-contain filter drop-shadow-sm my-1"
                    />
                    <span className="text-xs font-bold text-slate-800 dark:text-slate-200 truncate w-full">Charizard</span>
                    <span className="text-[10px] px-2 py-0.5 rounded bg-red-50 dark:bg-red-950/60 text-red-700 dark:text-red-400 mt-1 font-semibold border border-red-200/60 dark:border-red-900/40">Fire</span>
                  </div>

                  {/* #094 Gengar */}
                  <div className="bg-white dark:bg-slate-900 rounded-xl p-2.5 border border-slate-200/80 dark:border-slate-800 shadow-2xs flex flex-col items-center text-center">
                    <span className="text-[10px] font-mono text-slate-400 dark:text-slate-500 self-start">#094</span>
                    <img
                      src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/94.png"
                      alt="Gengar"
                      className="w-14 h-14 object-contain filter drop-shadow-sm my-1"
                    />
                    <span className="text-xs font-bold text-slate-800 dark:text-slate-200 truncate w-full">Gengar</span>
                    <span className="text-[10px] px-2 py-0.5 rounded bg-purple-50 dark:bg-purple-950/60 text-purple-700 dark:text-purple-400 mt-1 font-semibold border border-purple-200/60 dark:border-purple-900/40">Ghost</span>
                  </div>

                  {/* #448 Lucario */}
                  <div className="bg-white dark:bg-slate-900 rounded-xl p-2.5 border border-slate-200/80 dark:border-slate-800 shadow-2xs flex flex-col items-center text-center">
                    <span className="text-[10px] font-mono text-slate-400 dark:text-slate-500 self-start">#448</span>
                    <img
                      src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/448.png"
                      alt="Lucario"
                      className="w-14 h-14 object-contain filter drop-shadow-sm my-1"
                    />
                    <span className="text-xs font-bold text-slate-800 dark:text-slate-200 truncate w-full">Lucario</span>
                    <span className="text-[10px] px-2 py-0.5 rounded bg-blue-50 dark:bg-blue-950/60 text-blue-700 dark:text-blue-400 mt-1 font-semibold border border-blue-200/60 dark:border-blue-900/40">Steel</span>
                  </div>
                  ...
                  {[1, 2, 3].map((slot) => (
                    <div
                      key={slot}
                      className="bg-slate-100/70 dark:bg-slate-900/50 rounded-xl p-2.5 border border-dashed border-slate-300/80 dark:border-slate-800 flex flex-col items-center justify-center text-center py-5"
                    >
                      <Lock className="w-5 h-5 text-slate-400 dark:text-slate-600 mb-1" />
                      <span className="text-[11px] font-mono text-slate-400 dark:text-slate-600 font-bold">???</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="w-full max-w-md lg:max-w-lg rounded-2xl bg-slate-50/90 dark:bg-slate-950/80 text-slate-800 dark:text-slate-200 p-6 sm:p-7 border border-slate-200/90 dark:border-slate-800/80 shadow-2xs space-y-4 relative">
                ...
                <div className="flex items-center justify-between px-4 py-3 rounded-xl bg-white dark:bg-slate-900 border border-blue-400/60 dark:border-blue-500/50 shadow-xs">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-base font-semibold text-slate-900 dark:text-white">Gengar</span>
                    <span className="w-2 h-5 bg-blue-500 animate-pulse" />
                  </div>
                  <kbd className="px-2 py-0.5 rounded bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-xs font-mono text-slate-600 dark:text-slate-400 font-medium">
                    Esc to Clear
                  </kbd>
                </div>

                {/* Instant Match Result Card */}
                <div className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-2xs flex items-center gap-3.5">
                  <img
                    src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/94.png"
                    alt="Gengar"
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-bold text-slate-900 dark:text-white">#094 Gengar</span>
                      <span className="text-xs font-mono text-slate-400 dark:text-slate-500">Gen 1</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <span className="text-[10px] px-2 py-0.5 rounded bg-purple-50 dark:bg-purple-950/60 text-purple-700 dark:text-purple-400 border border-purple-200/70 dark:border-purple-900/40 font-semibold">Ghost</span>
                      <span className="text-[10px] px-2 py-0.5 rounded bg-violet-50 dark:bg-violet-950/60 text-violet-700 dark:text-violet-400 border border-violet-200/70 dark:border-violet-900/40 font-semibold">Poison</span>
                    </div>
                  </div>
                </div>

                {/* Type Matrix Matchup Pill Breakdown */}
                <div className="p-3.5 rounded-xl bg-white/80 dark:bg-slate-900/80 border border-slate-200/70 dark:border-slate-800 space-y-2">
                  <div className="flex justify-between text-xs font-mono">
                    <span className="text-slate-500 dark:text-slate-400">Immunity (0×)</span>
                    <span className="text-emerald-700 dark:text-emerald-400 font-semibold">Normal, Fighting</span>
                  </div>
                  <div className="flex justify-between text-xs font-mono">
                    <span className="text-slate-500 dark:text-slate-400">Weakness (2×)</span>
                    <span className="text-rose-600 dark:text-rose-400 font-semibold">Ground, Psychic, Ghost, Dark</span>
                  </div>
                </div>

                <div className="flex items-center justify-between pt-1 text-xs font-mono text-slate-500 dark:text-slate-400">
                  <span>Tab: Next match</span>
                  <span className="text-blue-600 dark:text-blue-400 font-semibold">Enter: Inspect Full Stats</span>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="hidden lg:flex w-full lg:w-1/2 items-center justify-center">
              <div className="w-full max-w-md lg:max-w-lg rounded-2xl bg-slate-50/90 dark:bg-slate-950/80 text-slate-800 dark:text-slate-200 p-6 sm:p-7 border border-slate-200/90 dark:border-slate-800/80 shadow-2xs relative overflow-hidden space-y-4">
                ...
                <div className="flex items-center justify-between pb-3 border-b border-slate-200/80 dark:border-slate-800">
                  <div className="flex items-center gap-2 text-amber-600 dark:text-amber-400 text-xs sm:text-sm font-bold font-mono">
                    <Trophy className="w-4 h-4 text-amber-500" />
                    <span>MINIGAME VICTORY</span>
                  </div>
                  <span className="text-[11px] font-mono px-2.5 py-0.5 rounded bg-amber-50 dark:bg-amber-950/60 text-amber-700 dark:text-amber-400 border border-amber-200 dark:border-amber-800/60 font-semibold">
                    5-WIN STREAK
                  </span>
                </div>

                {/* Newly Discovered Pokémon Holographic Showcase */}
                <div className="relative rounded-xl bg-gradient-to-b from-purple-50 via-white to-white dark:from-purple-950/30 dark:via-slate-900 dark:to-slate-900 p-5 border border-purple-200/80 dark:border-purple-900/60 shadow-2xs flex flex-col items-center text-center overflow-hidden">
                  <span className="text-[11px] font-mono text-purple-600 dark:text-purple-400 font-bold uppercase tracking-wider mb-2">
                  ...
                  <div className="space-y-1 mt-1">
                    <span className="text-base font-extrabold text-slate-900 dark:text-white">#149 Dragonite</span>
                    <div className="flex items-center justify-center gap-1.5 mt-1">
                      <span className="text-[10px] px-2 py-0.5 rounded bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-400 font-semibold border border-indigo-200/60 dark:border-indigo-900/40">Dragon</span>
                      <span className="text-[10px] px-2 py-0.5 rounded bg-sky-50 dark:bg-sky-950/60 text-sky-700 dark:text-sky-400 font-semibold border border-sky-200/60 dark:border-sky-900/40">Flying</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between pt-1 text-xs font-mono">
                  <span className="text-slate-500 dark:text-slate-400">Ledger Entry:</span>
