...
export const Toolbox: React.FC<ToolboxProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-2xl p-3.5 sm:p-4 border border-slate-200/90 dark:border-slate-800 space-y-3 transition-all relative z-10">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        {hasActiveFilters && onReset && (
          <button
            type="button"
            onClick={onReset}
            className="p-2.5 rounded-xl text-slate-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/40 border border-slate-200/80 dark:border-slate-700 hover:border-red-200 dark:hover:border-red-800 transition-all cursor-pointer group active:scale-95 shrink-0"
      ...
      <div className="flex flex-wrap items-center justify-between gap-2.5 pt-2 border-t border-slate-100/90 dark:border-slate-800 text-xs">
            ...
            >
              ...
              {selectedTypeTheme ? (
                <div className="flex items-center gap-1.5">
                  ...
                  />
                  <span className="text-slate-900 dark:text-white font-bold">{selectedTypeTheme.name}</span>
                </div>
              ) : (
                <span className="text-slate-800 dark:text-slate-200 font-bold">All Types</span>
              )}
              <ChevronDown
        ...
        {totalResults !== undefined && (
          <div className="text-[11px] text-slate-400 dark:text-slate-500 font-medium ml-auto flex items-center gap-1">
            <span>Showing</span>
