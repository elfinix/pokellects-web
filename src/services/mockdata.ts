...
export const ARENA_GAMES_METADATA: GameMetadata[] = [
  {
    ...
    description: 'A shadowy silhouette appears on the scanner. Identify the silhouette against the clock before the timer hits zero to register it directly into your Pokédex.',
    difficulty: 'Easy',
    isAvailable: true,
  ...
  },
  {
    id: 'hangmon',
    title: 'Hangmon',
    tagline: 'Guess letter-by-letter before strikes run out.',
    description: 'Solve the hidden Pokémon name tile-by-tile. Use category cues, letter patterns, and length clues. Too many wrong guesses and the wild Pokémon escapes!',
    difficulty: 'Medium',
    isAvailable: true,
  ...
  },
  {
    id: 'identicry',
    title: 'Identicry',
    tagline: 'Listen closely to the Pokémon cry.',
    description: 'Train your auditory knowledge! Hear the authentic synthesized or melodic cry of an unknown Pokémon and choose the correct species from the choices.',
    difficulty: 'Hard',
    isAvailable: true,
  ...
  },
  {
    id: 'pokedle',
    title: 'Pokédle',
    tagline: 'Wordle-style multi-criteria deduction.',
    description: 'Deduce the secret Pokémon using feedback on Type, Generation, Height, Weight, and Evolution Stage. Coming soon to Pokellects Arena!',
    difficulty: 'Medium',
    isAvailable: false,
